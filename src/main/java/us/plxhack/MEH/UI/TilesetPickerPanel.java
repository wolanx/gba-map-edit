...
public class TilesetPickerPanel extends JPanel {
    ...
    public void DrawTileset() {
        ...
        gcBuff.drawImage(global.getTileSet(viewingPalette), 0, 0, this);
        gcBuff.drawImage(local.getTileSet(viewingPalette), 0, global.getTileSet(viewingPalette).getHeight(), this);
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawImage(imgBuffer.getScaledInstance(256, 1024, Image.SCALE_FAST), 0, 0, this);
